...
const Navbar = () => {
    ...
    return (
        <>
            <div ref={navbarRef} className="selection:text-black selection:bg-white">
                ...
                <button className="border-gray-400 border-1 py-1 px-2 md:hidden" onClick={toggleMobileMenu}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" className="w-8 h-6">
                        <path stroke="rgba(225, 255, 255)" strokeLinecap="round" strokeMiterlimit="10" strokeWidth="2" d="M4 7h22M4 15h22M4 23h22" />
                    </svg>
                </button>
                </div>
                </div>
            ...
            {isMobileMenuOpen && (
                <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-100 z-50 flex flex-col justify-center items-center space-y-6 text-5xl" onClick={closeMobileMenu}>
                    <div className="text-white hover:text-gray-400 transition duration-300" onClick={(e)=> handleClick(e,()=>scrollToSection(sectionRefs.home))}>
                        Home
                    </div>
                    {/* <div className="text-white hover:text-gray-400 transition duration-300" onClick={(e)=> handleClick(e,()=>scrollToSection(sectionRefs.project))}>
                        Projects
                    </div> */}
                    <div className="text-white hover:text-gray-400 transition duration-300" onClick={(e)=> handleClick(e,()=>scrollToSection(sectionRefs.about))}>
                        About
                    </div>
